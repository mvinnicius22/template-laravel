    ...
    <form @submit.prevent="form.post(route('users.store'))">
        <div>
            ...
            <div>
                ...
                <input v-model="form.password" type="text" id="password" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
